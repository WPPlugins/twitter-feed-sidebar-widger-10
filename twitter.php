<?php
/*
Plugin Name: Twitter Feed Sidebar Widget 5.3
Version: 5.3
Plugin URI: http://www.dallasprowebdesigners.com/free-wordpress-plugins.html
Description: Show your latest tweets on your blog.Options to display your twitter profile info as well such as # of followers, following, avatar and more. Download this widget and give your site some life.
Author: Max
Author URI: http://www.dallasprowebdesigners.com/free-wordpress-plugins.html
*/

/*  Copyright 2011  Max (info@teamwebusa.com)
...
$twitter_options['widget_fields']['avatar'] = array('label'=>'Avatar:', 'type'=>'checkbox', 'default'=>false);
...
function twitter_messages($username = '', $num = 1, $list = false, $update = true, $linked  = '#', $hyperlinks = true, $twitter_users = true, $encode_utf8 = false) {
	...
	if ($username == '') {
		...
		if ($list) echo '</ul>';
                      ...
                      $name = "Website Design Company";  //this copyright notification is option and can be turned on an off from the admin section by the user
